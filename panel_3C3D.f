...
c     D.A.
c      DATA S(1),S(2),S(3),S(4),S(5),S(6)/
c     +    16.0,-08.0,10.0,0.0,0.0,0.0/
c      DATA S(1),S(2),S(3),S(4),S(5),S(6)/
c     +    -12.0,08.0,8.0,0.0,0.0,0.0/
...
111      write(*,*)
         ...
         if(ians2.eq.2)then
            ntracw=nx2-2*iedge
            write(*,*)
            write(*,*)'Enter desired x3 coordinate.'
            read(*,*)ix31
 ...
 50         continue
         elseif(ians2.eq.3)then
            ntracw=nx3-2*iedge
            write(*,*)
            write(*,*)'Enter desired x2 coordinate.'
            read(*,*)ix21
      ...
      do 1111 icol=1,3
         ...
         do 90 i=1,ntracw
            ...
            do iom=1,nom
               ...
               if(iom.le.nom2)then
                  work1(iom)=
     +                 uvc(icol,iom,ix3,ix2)*rfilt(iom)*cdexp(cxshift)
               else
...
c         CALL GACWK(4)
         ...
         call NGSETC('ME','./Output/wavepanel_3c.ps')
         CALL GOPWK(2,2,20)
         CALL GACWK(2)
